...
import { RequestResponse } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object';
import * as http from 'http';
import { Acl, AclMetadata } from '@google-cloud/storage/build/cjs/src/acl';
import { Channel } from '@google-cloud/storage/build/cjs/src/channel';
import { File, FileOptions, CreateResumableUploadOptions, CreateWriteStreamOptions } from '@google-cloud/storage/build/cjs/src/file';
import { Iam } from '@google-cloud/storage/build/cjs/src/iam';
import { Notification } from '@google-cloud/storage/build/cjs/src/notification';
import { Storage, Cors, PreconditionOptions, BucketOptions } from '@google-cloud/storage/build/cjs/src/storage';
import { GetSignedUrlResponse, GetSignedUrlCallback, SignerGetSignedUrlConfig, URLSigner, Query } from '@google-cloud/storage/build/cjs/src/signer';
import { Readable } from 'stream';
import { CRC32CValidatorGenerator } from '@google-cloud/storage/build/cjs/src/crc32c';
import { URL } from 'url';
import { BaseMetadata, SetMetadataOptions } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object';
