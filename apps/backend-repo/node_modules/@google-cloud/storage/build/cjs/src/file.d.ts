...
import * as resumableUpload from '@google-cloud/storage/build/cjs/src/resumable-upload';
import { Writable, Readable, PipelineSource } from 'stream';
import * as http from 'http';
import { PreconditionOptions, Storage } from '@google-cloud/storage/build/cjs/src/storage';
import { AvailableServiceObjectMethods, Bucket } from '@google-cloud/storage/build/cjs/src/bucket';
import { Acl, AclMetadata } from '@google-cloud/storage/build/cjs/src/acl';
import { GetSignedUrlResponse, GetSignedUrlCallback, URLSigner, SignerGetSignedUrlConfig, Query } from '@google-cloud/storage/build/cjs/src/signer';
import { Duplexify, GCCL_GCS_CMD_KEY } from '@google-cloud/storage/build/cjs/src/nodejs-common/util';
import { CRC32C, CRC32CValidatorGenerator } from '@google-cloud/storage/build/cjs/src/crc32c';
import { URL } from 'url';
import { BaseMetadata, DeleteCallback, DeleteOptions, GetResponse, InstanceResponseCallback, RequestResponse, SetMetadataOptions } from '@google-cloud/storage/build/cjs/src/nodejs-common/service-object';
